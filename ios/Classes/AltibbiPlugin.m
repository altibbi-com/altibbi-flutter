#import "AltibbiPlugin.h"
#import <OpenTok/OpenTok.h>
#import "OpenTok.h"
#import "Video.h"

@interface AltibbiPlugin () <FLTOpenTokHostApi>
@property FLTOpenTokPlatformApi *opentokFlutterApi;
@end

@interface AltibbiPlugin () <OTSessionDelegate, OTSubscriberDelegate, OTPublisherDelegate>
@property (nonatomic) OTSession *session;
@property (nonatomic) OTPublisher *publisher;
@property (nonatomic) OTSubscriber *subscriber;
@end

@implementation AltibbiPlugin
OpentokVideoFactory *factory;

// MARK: Plugin initialization
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
  AltibbiPlugin *instance = [[AltibbiPlugin alloc] init];
