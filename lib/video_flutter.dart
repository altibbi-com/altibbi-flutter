...
class OpenTokFlutter implements OpenTokPlatformApi {
  ...
  /// [VideoConfig] contains API key, Session Id & Token.
  OpenTokFlutter(VideoConfig config, {this.onUpdate}) : _config = config {
